    ...
    <div class="home">
        <div>
            ...
            <hero>
                ...
                <overlay  data-aos="fade-left" data-aos-duration="1050" :is-hero="true" img="/img/assets/heros/home.jpg">
                    <overlay-content to="/projects/saveme">
                        <template v-slot:subtitle>Latest concept</template>
                        <template v-slot:title>Saveme Dashboard</template>
                        <template>
                            CHECK IT OUT <i class="fa fa-long-arrow-alt-right ml-16"></i>
                        </template>
                    </overlay-content>
                </overlay>
